...
export const ProjectsArray = [
    {
        row: [
            ...
            {
                name: 'Centralised Reservation System (CRS)',
                desc: 'Build on Next JS to manage all of the property details at one place and also to change anything from those details, changed details will reflect those changes in database',
                link: 'https://channel-manager-nextjs.vercel.app/',
                image: CRS
            }
        ]
    },
